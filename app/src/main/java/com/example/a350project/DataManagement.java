...
public class DataManagement {
    ...
    private static String sessionDatabase = "Sessions00.txt";
    private static String userDatabase = "UserDatabase00.txt";
    private static String complaintsDatabase = "ComplaintsFile5.txt";
